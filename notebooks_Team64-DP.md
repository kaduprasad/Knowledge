...
**Team Number:** 64  
**Group ID (G):** 64  
Dynamic Programming solution for the autonomous drone rescue problem. Kept the model small enough to inspect by hand, but included all required MDP pieces: state definition, action dynamics, rewards, stochastic wind transitions, value iteration, policy plots, value heatmaps, and a scalability note.
...
EXECUTION DETAILS
============================================================
Execution Timestamp : 2026-06-07 02:27:02
Machine Name        : emscripten
Virtual Machine ID  : 254785447185153
Operating System    : Emscripten 4.0.9
...
![Cell 10 output](notebooks_Team64-DP_files/output_10_1.png)
...
def simulate_policy(env, policy, num_episodes=10, verbose=True):
    ...
    appended the current steps_remaining value used by the DP model.
    """
    results = []
...
---------------------
  ...
  Step 49:    Up -> Pos=(1,4) Bat=7 Reward=-1
  Step 50:    Up -> Pos=(0,4) Bat=6 Reward=+20
...
![Cell 14 output](notebooks_Team64-DP_files/output_14_2.png)
...
![Cell 14 output](notebooks_Team64-DP_files/output_14_4.png)
...
![Cell 14 output](notebooks_Team64-DP_files/output_14_6.png)
...
![Cell 15 output](notebooks_Team64-DP_files/output_15_1.png)
...
![Cell 17 output](notebooks_Team64-DP_files/output_17_2.png)
...
![Cell 17 output](notebooks_Team64-DP_files/output_17_4.png)
...
![Cell 17 output](notebooks_Team64-DP_files/output_17_6.png)
...
![Cell 18 output](notebooks_Team64-DP_files/output_18_2.png)
...
Execution Timestamp: 2026-06-07 02:28:21
======================================================================
```
